...
| TD-15 | **Carga de app = 12 requests** (sin `getBootstrap`) | GAS-C2 | Latencia alta y ×12 invocaciones por carga/refresh | M | Acción `getBootstrap` que lea todas las hojas en una ejecución. |
